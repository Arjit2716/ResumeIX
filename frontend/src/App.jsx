  ...
  return (
    <div style={{ minHeight: "100vh", background: C.bg, color: C.text, fontFamily: font }}>
      ...
      <footer style={{ borderTop: `1px solid ${C.border}`, padding: "24px 24px 28px", textAlign: "center" }}>
        ...
        <a href="https://github.com/Arjit2716/ResumeIX" target="_blank" rel="noopener noreferrer" style={{ fontSize: 10, color: C.muted, textDecoration: "none", border: `1px solid ${C.border}`, padding: "5px 14px", borderRadius: 3, transition: "all 0.2s", display: "inline-block", marginRight: 8 }}
